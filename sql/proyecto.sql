...
CREATE TABLE `usuarios` (
  ...
  `tipoletra` varchar(30) NOT NULL DEFAULT 'Consolas'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `usuarios` (`usuario`, `clave`, `nombrecompleto`, `correo`, `colorfondo`, `tipoletra`) VALUES
('admin', '9010e72389a80487d473017425c6ec7951068abed82a4df32459c91f0e45d2ea', 'Administrador', 'admin@admin.com', '#FFFFFF', 'Consolas'),
('Héctor', '9d831c26e34a515f8dd5f7b85a29039a61ba1699270fc2bddc52aa0ca5667065', 'Héctor Olivares Sánchez', 'hector@hector.com', '#FFFFFF', 'Consolas'),
('usuario', 'd8e0fd621f8745ab21c9c7de66778d00d9d41b2e2682a5fbc5bff87361c47102', 'Usuario 1', 'usuario@usuario.com', '#FFFFFF', 'Consolas');
